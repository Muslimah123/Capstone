...
<li class="nav-item">
  <a class="nav-link text-white " href="./tables.html">
    ...
    <span class="nav-link-text ms-1">Sales Revenue</span>
  </a>
</li>
...
<li class="nav-item">
  <a class="nav-link text-white " href="./billing.html">
    ...
    <span class="nav-link-text ms-1">Profit Margin</span>
  </a>
</li>
...
<li class="nav-item">
  <a class="nav-link text-white " href="./virtual-reality.html">
    ...
    <span class="nav-link-text ms-1">Cost of Goods sold</span>
  </a>
</li>
<li class="nav-item">
  <a class="nav-link text-white " href="./virtual-reality.html">
...
<li class="nav-item">
  <a class="nav-link text-white " href="./notifications.html">
    ...
    <span class="nav-link-text ms-1">Customer acquisition cost</span>
  </a>
</li>
...
<li class="nav-item">
  <a class="nav-link text-white " href="./virtual-reality.html">
    ...
    <span class="nav-link-text ms-1">Return on investment</span>
  </a>
</li>
...
<div class="row">
  ...
  <h2 class="font-weight-bolder mb-0">General Statistics</h2>
    ...
    <div class="text-end pt-1">
      <p class="text-sm mb-0 text-capitalize">Sales Revenue</p>
  ...
  <div class="card-header p-3 pt-2">
    ...
    <div class="text-end pt-1">
      <p class="text-sm mb-0 text-capitalize">Profit Margin</p>
  ...
  <div class="card-header p-3 pt-2 bg-transparent">
    ...
    <div class="text-end pt-1">
      <p class="text-sm mb-0 text-capitalize ">cost of goods sold</p>
  ...
  <div class="card-header p-3 pt-2 bg-transparent">
    ...
    <div class="text-end pt-1">
      <p class="text-sm mb-0 text-capitalize ">Inventory levels</p>
      <h4 class="mb-0 ">+91</h4>
    </div>
  </div>
